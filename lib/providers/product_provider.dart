...
class ProductProvider extends ChangeNotifier {
  ...
  List<ProductModel> gitSearchList({required String searchText}) {
  ...
  final userDc = FirebaseFirestore.instance.collection('products');

  Stream<List<ProductModel>> fetchDataStream() {
    try {
      return userDc.snapshots().map((snapshot) {
        products.clear();
